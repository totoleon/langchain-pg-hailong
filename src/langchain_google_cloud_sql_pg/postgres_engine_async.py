...
class AsyncPostgresEngine:
    ...
    async def from_instance(
        ...
        """Create an instance of PostgresEngine from Cloud SQL instance
        details.
        ...
        Returns:
            (PostgresEngine): The engine configured to connect to a
                Cloud SQL instance database.
        """
        engine = await cls._create_connector_engine(
    ...
    async def connect(self) -> sqlalchemy.engine.Connection:
